      ...
      <div className="mt-16 px-4">
        ...
        <div className="mt-8">
          ...
          <form className="flex flex-col mt-8">
            ...
            <div className="mt-1">
              {method === "email" ? <input type="email" className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500" required></input> : null}
              {method === "phone" ? (
                <div className="flex rounded-md shadow-sm">
                  ...
                  <input type="number" className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md rounded-l-none focus:outline-none focus:ring-orange-500 focus:border-orange-500" required/>
                </div>
              ) : null}
            </div>
